...
%% Read FVT_HALOUT.arxml for output port order
...
tmpCell1 = extractBetween(Target_arxml(Raw_start+h-1,1),'SWC_HALOUT_type/','</PORT-PROTOTYPE-REF>');
...
for i = 1:length(CAN_Msg_Output_array)
    while i <= length(CAN_Msg_Output_array) && ...
        ...
        && ~startsWith(CAN_Msg_Output_array(i),'IRV_J1939_CAN')
...
%         end
        ...
        if (strcmp(string(Channel),'CAN1') && (strcmp(string(MsgName),'FD1_VCU2') || strcmp(string(MsgName),'FD1_VCU3') || strcmp(string(MsgName),'VMC_FCM1')))...
           ...
           || (strcmp(string(Channel),'CAN4') && strcmp(string(MsgName),'FD4_xxCE100xx_0'))...
