function FVT_SWC_Autobuild_D31()
...
ElseOutport_array = {'VOUTP_NetworkReq_flg';'VOUTP_SysPowerMode_enum';'VOUTP_NvWriteReqRisingEdge_flg';...
                    ...
                    'E2E_CAN3_VCU1_Trigger';'E2E_CAN4_VCU1_Trigger'};
...
CDDModel = ['R_E2E_CAN3_VCU1_CSOP_Write_CAN3_VCU1';'R_E2E_CAN4_VCU1_CSOP_Write_CAN4_VCU1'];
CDDModel_array = string(CDDModel);
h(1) = get_param([TargetModel '/' char(CDDModel_array(1))],'Handle');
h(2) = get_param([TargetModel '/' char(CDDModel_array(2))],'Handle');
Simulink.BlockDiagram.createSubsystem(h);
...
set_param(h,'Name',char(CDDModel_array(1)));
h = get_param([TargetModel '/Subsystem/Subsystem1'],'Handle');
set_param(h,'Name',char(CDDModel_array(2)));
h = get_param([TargetModel '/Subsystem'],'Handle');
...
HALOUT_CDD_Info = {'CDD_Name','Inputport_Name','Input_Name','Trigger_Name';...
                   ...
                   'R_HALOUTCDD_CSOP_SetAcoreRebootCmdACK','','','';...
                   'HALOUT_AFTER',{'E2E_CAN3_VCU1_Trigger';'E2E_CAN4_VCU1_Trigger'},{'E2E_CAN3_VCU1_Trigger';'E2E_CAN4_VCU1_Trigger'},'trig_HAL_OUTAFTER_50_1';...
...
CDDModel_array = ["R_E2E_CAN3_VCU1_CSOP_Write_CAN3_VCU1";"R_E2E_CAN4_VCU1_CSOP_Write_CAN4_VCU1"];
BlockName = 'Enable';
...
for i = 1:length(RUNNABLE_array)
    idx = contains(RUNNABLES_BlockList,RUNNABLE_array(i));
    if ~any(idx)
