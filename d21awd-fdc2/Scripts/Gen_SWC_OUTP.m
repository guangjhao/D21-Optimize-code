function Gen_SWC_OUTP()
%% Initial settings
ref_car_model = {'d31f-fdc', 'd31hawd-fdc2', 'd21-fdc2'};
...
for i = 1:num_pro_app_dir
    ...
    if ((num_str==3)||(num_str==4)) && ~strcmp(str,'scp')
        k =k+1;
        ref_module(k,1) = str;
    end 
end 
...
% run Build_SWC_APP
Module = 'OUTP';
Build_SWC_APP(Module,Arry_sig,project_path)
cd(arch_Path);
disp('FVT_OUTP.arxml Done!');
