...
DIDNum_FoxPiDrivingCtrl         	=	uint16(0x1001);
DIDLen_FoxPiDrivingCtrl         	=	uint16(21);
...
DIDNum_FoxPiMotionSta           	=	uint16(0x1002);
DIDLen_FoxPiMotionSta           	=	uint16(13);

DIDNum_FoxPiBrakeSta            	=	uint16(0x1003);
DIDLen_FoxPiBrakeSta            	=	uint16(13);

DIDNum_FoxPiWheelSpd            	=	uint16(0x1004);
DIDLen_FoxPiWheelSpd            	=	uint16(16);

DIDNum_FoxPiEPSSta              	=	uint16(0x1005);
DIDLen_FoxPiEPSSta              	=	uint16(11);

DIDNum_FoxPiButtonSta           	=	uint16(0x1006);
DIDLen_FoxPiButtonSta           	=	uint16(2);

DIDNum_FoxPiUSSDist             	=	uint16(0x1007);
DIDLen_FoxPiUSSDist             	=	uint16(20);

DIDNum_FoxPiUSSFaultSta         	=	uint16(0x1008);
DIDLen_FoxPiUSSFaultSta         	=	uint16(2);

DIDNum_FoxPiPTGUSSSw            	=	uint16(0x1009);
DIDLen_FoxPiPTGUSSSw            	=	uint16(1);

DIDNum_FoxPiSwSta               	=	uint16(0x100A);
DIDLen_FoxPiSwSta               	=	uint16(2);

DIDNum_FoxPiLampSta             	=	uint16(0x100B);
DIDLen_FoxPiLampSta             	=	uint16(2);

DIDNum_FoxPiLampCtrl            	=	uint16(0x100C);
DIDLen_FoxPiLampCtrl            	=	uint16(6);
...
DIDNum_FoxPiBattSta             	=	uint16(0x100D);
DIDLen_FoxPiBattSta             	=	uint16(4);

DIDNum_FoxPiTPMSSta             	=	uint16(0x100E);
DIDLen_FoxPiTPMSSta             	=	uint16(13);

DIDNum_FoxPiPedalPos            	=	uint16(0x100F);
DIDLen_FoxPiPedalPos            	=	uint16(3);

DIDNum_FoxPiMotorSta            	=	uint16(0x1010);
DIDLen_FoxPiMotorSta            	=	uint16(11);

DIDNum_FoxPiShifterAllow        	=	uint16(0x1011);
DIDLen_FoxPiShifterAllow        	=	uint16(3);

DIDNum_FoxPiCtrlEnSw            	=	uint16(0x1012);
DIDLen_FoxPiCtrlEnSw            	=	uint16(1);
...
% VINP_LKATOIAct_enum
ENUM_LKATOIACT_NOACTIVE             = uint8(  0  );
ENUM_LKATOIACT_ACTIVE               = uint8(  1  );
