...
#define NUM_CAN_CH1_RX_MSG 12
#define NUM_CAN_CH2_RX_MSG 1
#define NUM_CAN_CH3_RX_MSG 12
#define NUM_CAN_CH4_RX_MSG 5
#define NUM_CAN_CH6_RX_MSG 3
#define NUM_CAN_CH7_RX_MSG 4

#define NUM_LIN_CHANNEL 0

#define CAR_MODEL    TA2
...
extern uint8_t ApiDio_GetAccIn(void);
...
extern uint8_t ApiDio_GetDrvDrHdlSignal(void);
extern uint8_t ApiDio_GetPaxDrHdlSignal(void);
