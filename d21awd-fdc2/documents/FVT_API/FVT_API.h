...
extern float   ApiAdc_GetPedal1Vol_V(void);
extern float   ApiAdc_GetPedal2Vol_V(void);
extern float   ApiAdc_GetPedal1RefVol_V(void);
extern float   ApiAdc_GetPedal2RefVol_V(void);
...
extern uint8_t ApiSys_ZEVGetDIDdata(uint16_t DID, uint8_t *Data, uint16_t DataLength);
extern uint8_t ApiSys_ZEVSetDIDdata(uint16_t DID, const uint8_t *Data, uint16_t DataLength);
extern uint8_t ApiSys_DKCGetDIDdata(uint16_t DID, uint8_t *Data, uint16_t DataLength);
extern uint8_t ApiSys_DKCSetDIDdata(uint16_t DID, const uint8_t *Data, uint16_t DataLength);
...
extern uint8_t dkc_uwb_status_get(const uint8_t *buf, const uint8_t len);
...
/* Get Aux battery voltage*/
extern uint16_t ApiAdc_GetBAT_Vol_100mV(void);
