...
DIDNum_DKCSta                   	=	uint16(0x0F07);
DIDLen_DKCSta                   	=	uint16(2);

DIDNum_DKCBLESta                	=	uint16(0x0F08);
DIDLen_DKCBLESta                	=	uint16(2);

DIDNum_UWBAnchorSta             	=	uint16(0x0F09);
DIDLen_UWBAnchorSta             	=	uint16(93);

DIDNum_LIDAAnchorSta            	=	uint16(0x0F0A);
DIDLen_LIDAAnchorSta            	=	uint16(21);

DIDNum_DoorNFCAnchorSta         	=	uint16(0x0F0B);
DIDLen_DoorNFCAnchorSta         	=	uint16(21);

DIDNum_UIDSta                   	=	uint16(0x0F0C);
DIDLen_UIDSta                   	=	uint16(26);

DIDNum_FDDKCCoordXY             	=	uint16(0x0F0D);
DIDLen_FDDKCCoordXY             	=	uint16(3);
...
% VDKC_UWBDetUnLockSta_enum
% VDKC_UWBDetUnlockKeepSta_enum
...
ENUM_PDKEYRAWLULOCK_OTHERZONE       = uint8( 255  );
...
% VTQD_WheelSkipSta_enum
ENUM_WHEELSKIPSTA_STABLE                    = uint8(  0  );
ENUM_WHEELSKIPSTA_LF                        = uint8(  1  );
ENUM_WHEELSKIPSTA_RF                        = uint8(  2  );
ENUM_WHEELSKIPSTA_LR                        = uint8(  3  );
ENUM_WHEELSKIPSTA_RR                        = uint8(  4  );
ENUM_WHEELSKIPSTA_LEFT                      = uint8(  5  );
ENUM_WHEELSKIPSTA_RIGHT                     = uint8(  6  );              
ENUM_WHEELSKIPSTA_FRONT                     = uint8(  7  );
ENUM_WHEELSKIPSTA_REAR                      = uint8(  8  );
ENUM_WHEELSKIPSTA_LFRR                      = uint8(  9  );
ENUM_WHEELSKIPSTA_RFLR                      = uint8(  10  );
ENUM_WHEELSKIPSTA_FRONTLR                   = uint8(  11  );
ENUM_WHEELSKIPSTA_FRONTRR                   = uint8(  12  );
ENUM_WHEELSKIPSTA_REARLF                    = uint8(  13  );
ENUM_WHEELSKIPSTA_REARRF                    = uint8(  14  );
ENUM_WHEELSKIPSTA_ALLWHEELS                 = uint8(  15  );
 
%VTQD_SkipDirect_enum
ENUM_SKIPDIRECT_NONE                        = uint8(  0  );
ENUM_SKIPDIRECT_POSITIVE                    = uint8(  1  );              
ENUM_SKIPDIRECT_NEGATIVE                    = uint8(  2  );
 
%VTQD_WhlSkipDisCreep_enum
ENUM_SKIPDISCREEP_NORMAL                    = uint8(  0  );
ENUM_SKIPDISCREEP_LOW                       = uint8(  1  );
ENUM_SKIPDISCREEP_MEDIUM                    = uint8(  2  ); 
ENUM_SKIPDISCREEP_HIGH                      = uint8(  3  );
ENUM_SKIPDISCREEP_INVALID                   = uint8(  4  );
 
%VTQD_WhlSkipDisOPDHold_enum
ENUM_SKIPDISOPDHOLD_NORMAL                    = uint8(  0  );
ENUM_SKIPDISOPDHOLD_LOW                       = uint8(  1  );
ENUM_SKIPDISOPDHOLD_HIGH                      = uint8(  2  );
ENUM_SKIPDISOPDHOLD_INVALID                   = uint8(  3  );

%VTQD_CTDCtrl_enum
ENUM_CTDCTRL_NOCMD                              = uint8(  0  );
ENUM_CTDCTRL_UNLOCKDRDOOR                       = uint8(  1  );
ENUM_CTDCTRL_UNLOCKALL                          = uint8(  2  );
ENUM_CTDCTRL_LOCKALL                            = uint8(  3  );
...
ENUM_HVPO120VGRPDST_RED                       = uint8(  1  );
ENUM_HVPO120VGRPDST_GREEN                     = uint8(  2  );
...
% VINP_APSStaSystem_enum
% VHAL_APSStaSystem_enum
% VOUTP_APSStaSys_enum
% VAPS_APSStaSystem_enum
% KINP_APSStaSystem_enum_ovrdval
% VDKC_APSStaSystem_enum
% KDKC_APSStaSystem_enum_ovrdval
...
% VINP_ADASFCWSta_enum
ENUM_ADASFCWSTA_OFF             = uint8(  0  );
ENUM_ADASFCWSTA_STANDBY         = uint8(  1  );
ENUM_ADASFCWSTA_ACTIVE          = uint8(  2  );
ENUM_ADASLDWSTA_ERROR           = uint8(  3  );
ENUM_ADASLDWSTA_DISABLE         = uint8(  4  );
...
ENUM_UIDBUTTON_RAPSSTARTPRESS       = uint8(  7  );
ENUM_UIDBUTTON_RAPSFORWARDPRESS     = uint8(  8  );
ENUM_UIDBUTTON_RAPSBACKWARDPRESS    = uint8(  9  );
ENUM_UIDBUTTON_RAPSSTARTRELEASE     = uint8(  10  );
ENUM_UIDBUTTON_RAPSFORWARDRELEASE   = uint8(  11  );
ENUM_UIDBUTTON_RAPSBACKWARRELEASE   = uint8(  12  );
...
% VDKC_DkeyAreaRAPSSta_enum
% VDKC_DkeyRAPSAreaRaw_enum
% VDKC_UWBDetRAPSZoneKeep_enum
% KDKC_KeyUWBDetRAPSArea_enum_ovrdval
ENUM_PDKEYRAPSRAW_UNAVALIABLE      = uint8(  0  );
ENUM_PDKEYRAPSRAW_INTOZONE         = uint8(  1  );
ENUM_PDKEYRAPSRAW_OUTZONE          = uint8(  2  );
...
% VDKC_OutputPCMDModule_enum
ENUM_PCMD_DEFAULT                   = uint8(  0  );
ENUM_PCMD_UIDBUTTON                 = uint8(  1  );
ENUM_PCMD_TRUNKHAND                 = uint8(  2  );
ENUM_PCMD_NFCDETECT                 = uint8(  3  );
ENUM_PCMD_PTGJUDGE                  = uint8(  4  );
ENUM_PCMD_AUTOLOCKJUDGE             = uint8(  5  );
ENUM_PCMD_UWBDETEDT                 = uint8(  6  );
ENUM_PCMD_RSSIJUDGELOCK             = uint8(  7  );

% VDKC_BLERSSI_enum
ENUM_RSSI_MAX                       = uint8(  0  );
ENUM_RSSI_UNAVAILABLE               = uint8( 255 );

% VDKC_UWBDetPTGArea_enum
ENUM_PDKEYPTGAREA_UNAVALIABLE       = uint8(  0  );
ENUM_PDKEYPTGAREA_SPTGZONE          = uint8(  1  );
ENUM_PDKEYPTGAREA_PTGZONE           = uint8(  2  );
ENUM_PDKEYPTGAREA_GRAYSPTGZONE 		= uint8(  3  );

% VDKC_ParkingMode_enum
ENUM_PARKINGMODE_DISABLE            = uint8(  0  );
ENUM_PARKINGMODE_STANDBY            = uint8(  1  );
ENUM_PARKINGMODE_REMOTEPARKING      = uint8(  2  );
ENUM_PARKINGMODE_REMOTEFORWARD 		= uint8(  3  );
ENUM_PARKINGMODE_REMOTEREVERSE 		= uint8(  4  );

% VINP_UWBxDistance_cm
ENUM_UWBXDISTANCE_ONCANINVALID      = uint16(  2550  );

% VINP_UWB1Power_dB
ENUM_UWBPOWER_BSWINVALID            = int16( 127 );

% VDKC_UWBXFPP_enum
ENUM_UWBPOWER_ONCANINVALID          = int16( 128 );

% VINP_UWBpositionX_cm
ENUM_UWBPOSX_BSWINVALID             = int16( 32767 );

% VINP_UWBpositionY_cm
ENUM_UWBPOSY_BSWINVALID             = int16( 32767 );

% VDKC_CoordinateX_enum
ENUM_UWBPOSX_ONCANINVALID           = int16( -2550 );
ENUM_UWBPOSX_ONCANEXRANGE           = int16(  2560 );

% VDKC_CoordinateY_enum
ENUM_UWBPOSY_ONCANINVALID           = int16( -2550 );
ENUM_UWBPOSY_ONCANEXRANGE           = int16(  2560 );

% VINP_UWB1RangingSta_enum
% VDKC_UWB1Invalid_flg
% KINP_UWB1RangingSta_enum_ovrdval
% VINP_UWB2RangingSta_enum
% VDKC_UWB2Invalid_flg
% KINP_UWB2RangingSta_enum_ovrdval
% VINP_UWB3RangingSta_enum
% VDKC_UWB3Invalid_flg
% KINP_UWB3RangingSta_enum_ovrdval
% VINP_UWB4RangingSta_enum
% VDKC_UWB4Invalid_flg
% KINP_UWB4RangingSta_enum_ovrdval
% VINP_UWB5RangingSta_enum
% VDKC_UWB5Invalid_flg
% KINP_UWB5RangingSta_enum_ovrdval
ENUM_UWBRANGINGSTA_VALID             = uint8(  0  );
ENUM_UWBRANGINGSTA_INVALID           = uint8(  1  );
ENUM_UWBRANGINGSTA_BROKEN            = uint8(  2  );
ENUM_UWBRANGINGSTA_NOUSED            = uint8(  3  );
...
ENUM_VEHICLETYPE_P71            = uint8(  5  ); %TBD
...
%% -----------------------20250604 DDM-----------------------------------
% VAPM_RAPSErrWarnSta_enum
ENUM_RAPSErrWarnSta_NORMAL            = uint8(  0  );
ENUM_RAPSErrWarnSta_RAPSERRLV1        = uint8(  1  );
ENUM_RAPSErrWarnSta_RAPSERRLV2        = uint8(  2  );

% VINP_ESCAPSSta_enum
ENUM_ESCAPSSta_OFF                     = uint8(  0  );
ENUM_ESCAPSSta_STANDBY                 = uint8(  1  );
ENUM_ESCAPSSta_DECELCONTROL            = uint8(  2  );
ENUM_ESCAPSSta_STANDSTILLWITHBRAKEHOLD = uint8(  3  );
ENUM_ESCAPSSta_STANDSTILLWITHEPB       = uint8(  4  );
ENUM_ESCAPSSta_APSUNAVAILABLE          = uint8(  5  );

%% -----------------------20250604 PMM-----------------------------------
% VPMM_HWResetSta_enum
ENUM_HWRESETSTA_NORESET                = uint8(  0  );
ENUM_HWRESETSTA_HWRESETING             = uint8(  1  );
ENUM_HWRESETSTA_HWRESETFINISH          = uint8(  2  );

%% -----------------------20250220 TQD------------------------------------

%VTQD_WheeSkiplSta_enum
ENUM_WHEELSKIPSTA_STABLE              = uint8(  0  );
ENUM_WHEELSKIPSTA_LF                  = uint8(  1  );
ENUM_WHEELSKIPSTA_RF                  = uint8(  2  );
ENUM_WHEELSKIPSTA_LR                  = uint8(  3  );
...
ENUM_COMBOKEY_REGENDOWN          = uint8(1);
ENUM_COMBOKEY_REGENUP            = uint8(2);
ENUM_COMBOKEY_RESUP              = uint8(3);
ENUM_COMBOKEY_SETDOWN            = uint8(4);
ENUM_COMBOKEY_SWCUP              = uint8(5);
ENUM_COMBOKEY_SWCDOWN            = uint8(6);
ENUM_COMBOKEY_CANCEL             = uint8(7);
ENUM_COMBOKEY_SWCACC             = uint8(8);
ENUM_COMBOKEY_DISTANCE           = uint8(9);
ENUM_COMBOKEY_SWCMODE            = uint8(10);
ENUM_COMBOKEY_SWCRIGHT           = uint8(11);
ENUM_COMBOKEY_SWCLEFT            = uint8(12);

%% -----------------------20250602 TQD------------------------------------

%VTQD_TMEnOutpTqSta_enum
ENUM_TMENOUTPTQSTA_REAR          = uint8(0);
ENUM_TMENOUTPTQSTA_FRONT         = uint8(1);
ENUM_TMENOUTPTQSTA_BOTH          = uint8(2);

% VINP_DMSStatus_enum
ENUM_DMSSTATUS_OFF             = uint8(  0  );
ENUM_DMSSTATUS_ACTIVE       = uint8(  1  );
ENUM_DMSSTATUS_ERROR        = uint8(  2  );
ENUM_DMSSTATUS_DISABLE     = uint8(  3  );

% VINP_DMSWarningFatigue_enum
ENUM_DMSWARNINGFATIGUE_NOWARNING        = uint8(  0  );
ENUM_DMSWARNINGFATIGUE_DROWSINESS        = uint8(  1  );
ENUM_DMSWARNINGFATIGUE_MICROSLEEP         = uint8(  2  );
ENUM_DMSWARNINGFATIGUE_SLEEP                    = uint8(  3  );

% VINP_ADASLFCSTA_enum
ENUM_ADASLFCSTA_OFF                         = uint8(  0  );
ENUM_ADASLFCSTA_WHITE                     = uint8(  1  );
ENUM_ADASLFCSTA_GREEN                     = uint8(  2  );
ENUM_ADASLFCSTA_GREENBLINKING      = uint8(  3  );
ENUM_ADASLFCSTA_ERROR                     = uint8(  4  );
ENUM_ADASLFCSTA_DISABLE                   = uint8(  5  );

%%------------------------20250908 TQD--------------------------------
%VTQD_PedalMapAction_enum
ENUM_PEDALMAPACTION_NOLHMN               = uint8(0)
ENUM_PEDALMAPACTION_LHM                  = uint8(1)
ENUM_PEDALMAPACTION_NOLHMDROCK           = uint8(2)
ENUM_PEDALMAPACTION_NOLHMDSNOW           = uint8(3)
ENUM_PEDALMAPACTION_NOLHMDNRMLV1         = uint8(4)
ENUM_PEDALMAPACTION_NOLHMDNRMLV2         = uint8(5)
ENUM_PEDALMAPACTION_NOLHMDNRMLV3         = uint8(6)
ENUM_PEDALMAPACTION_NOLHMDNRMLV4         = uint8(7)
ENUM_PEDALMAPACTION_NOLHMDNRMLV5         = uint8(8)
ENUM_PEDALMAPACTION_NOLHMDNRMOPD         = uint8(9)
ENUM_PEDALMAPACTION_NOLHMDNRMINV         = uint8(10)
ENUM_PEDALMAPACTION_NOLHMDECOLV1         = uint8(11)
ENUM_PEDALMAPACTION_NOLHMDECOLV2         = uint8(12)
ENUM_PEDALMAPACTION_NOLHMDECOLV3         = uint8(13)
ENUM_PEDALMAPACTION_NOLHMDECOLV4         = uint8(14)
ENUM_PEDALMAPACTION_NOLHMDECOLV5         = uint8(15)
ENUM_PEDALMAPACTION_NOLHMDECOOPD         = uint8(16)
ENUM_PEDALMAPACTION_NOLHMDECOINV         = uint8(17)
ENUM_PEDALMAPACTION_NOLHMDSPORTLV1       = uint8(18)
ENUM_PEDALMAPACTION_NOLHMDSPORTLV2       = uint8(19)
ENUM_PEDALMAPACTION_NOLHMDSPORTLV3       = uint8(20)
ENUM_PEDALMAPACTION_NOLHMDSPORTLV4       = uint8(21)
ENUM_PEDALMAPACTION_NOLHMDSPORTLV5       = uint8(22)
ENUM_PEDALMAPACTION_NOLHMDSPORTOPD       = uint8(23)
ENUM_PEDALMAPACTION_NOLHMDSPORTINV       = uint8(24)
ENUM_PEDALMAPACTION_NOLHMR               = uint8(25)
