...
disp('Loading $Id: hal_tpms_var.m  2024-08-29 17:57:56    foxtron $      FVT_export_businfo_v2.0 2021-11-02')
...
a2l_mon('VHAL_TPMSSensorIDRegSta_enum', 	'enum',    0,    4,    'uint8',    '');
a2l_mon('VHAL_TPMSTrigger_flg', 	'flg',    0,    1,    'boolean',    '');
