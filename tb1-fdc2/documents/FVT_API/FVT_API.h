...
#define NUM_CAN_CH1_RX_MSG 10
#define NUM_CAN_CH2_RX_MSG 4
#define NUM_CAN_CH3_RX_MSG 11
#define NUM_CAN_CH4_RX_MSG 11
#define NUM_CAN_CH6_RX_MSG 3
#define NUM_CAN_CH7_RX_MSG 1

#define NUM_LIN_CHANNEL 0

#define CAR_MODEL TB1
#define CONTROLLER FD
#define COUNTRY TW
#define	CAR_MODEL_VARIATION A
