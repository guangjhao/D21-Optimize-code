%===========$Update Time :  2025-02-26 10:33:29 $=========
disp('Loading $Id: nmm_var.m  2025-02-26 10:33:29    foxtron $      FVT_export_businfo_v2.0 2021-11-02')
...
a2l_mon('VNMM_EVCCWakeNetReq_flg', 	'flg',    0,    1,    'boolean',    '');
...
a2l_mon('VNMM_NetworkReqCalled_flg', 	'flg',    0,    1,    'boolean',    '');
