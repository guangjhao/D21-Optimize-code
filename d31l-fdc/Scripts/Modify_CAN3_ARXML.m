...
% FD3_VCU1
location_FD3_VCU1 = find(contains(CAN3_arxml, '              <SYSTEM-SIGNAL-GROUP-REF DEST="SYSTEM-SIGNAL-GROUP">/CAN3/SignalGroup/CAN3_SG_FD_VCU0</SYSTEM-SIGNAL-GROUP-REF>'), 1, 'first') + 3;
...
FD3_VCU1_cell(end+1, 1) =       {'                  <DATA-TRANSFORMATION-REF DEST="DATA-TRANSFORMATION">/DataTransformations/DataTransformationSet/E2E_PROFILE_01_CAN3_SG_FD_VCU1</DATA-TRANSFORMATION-REF>'};
FD3_VCU1_cell(end+1, 1) =       {'                </DATA-TRANSFORMATION-REF-CONDITIONAL>'};
FD3_VCU1_cell(end+1, 1) =       {'              </COM-BASED-SIGNAL-GROUP-TRANSFORMATIONS>'};
...
location_FD3_VCU1 = find(contains(CAN3_arxml, '              <SYSTEM-SIGNAL-GROUP-REF DEST="SYSTEM-SIGNAL-GROUP">/CAN3/SignalGroup/CAN3_SG_FD_VCU1</SYSTEM-SIGNAL-GROUP-REF>'), 1, 'first');
FD3_VCU1_cell = cell(1,1);
...
FD3_VCU1_cell(end+1, 1) =       {'                      <TRANSFORMER-REF DEST="TRANSFORMATION-TECHNOLOGY">/DataTransformations/DataTransformationSet/Technology_E2E_PROFILE_01_CAN3_SG_FD_VCU1</TRANSFORMER-REF>'};
FD3_VCU1_cell(end+1, 1) =       {'                      <DATA-IDS>'};
FD3_VCU1_cell(end+1, 1) =       {'                        <DATA-ID>13815</DATA-ID>'};
FD3_VCU1_cell(end+1, 1) =       {'                      </DATA-IDS>'};
