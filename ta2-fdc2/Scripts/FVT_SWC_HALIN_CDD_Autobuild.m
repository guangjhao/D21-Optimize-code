...
idx = ~contains(string(CDD_cell(:,1)),{'HALINCDD';'R_UDSCDD_CSOP_DdmClearDTCNotification';'R_HALIN_IMU_CSOP_IMUGetSixAxisVal';'R_HALIN_APS_CSOP_ApsGetData';'R_HALIN_IMU_CSOP_IMUGetOffsetVal';'R_HALOUT_APS_CSOP_ApsSetTimeout';'R_HALOUT_APS_CSOP_ApsSetData';'R_NVMReadCDD_Inner_NVM_ReadOperation'});
