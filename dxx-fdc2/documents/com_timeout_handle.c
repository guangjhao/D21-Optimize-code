...
FUNC(void, COM_APPL_CODE) CAN4_SG_ZONE_L1_ComNotification(void)
{
    fvt_rtsg_notification_handler(RTSG_CAN4_SG_ZONE_L1);
	VHAL_CANMsgInvalidZONEL1_flg = false;
}

FUNC(void, COM_APPL_CODE) CAN4_SG_ZONE_L1_ComTimeoutNotification(void)
{
    fvt_rtsg_timeout_handler(RTSG_CAN4_SG_ZONE_L1);
	VHAL_CANMsgInvalidZONEL1_flg = true;
}

FUNC(void, COM_APPL_CODE) CAN4_SG_ZONE_L2_ComNotification(void)
{
    fvt_rtsg_notification_handler(RTSG_CAN4_SG_ZONE_L2);
	VHAL_CANMsgInvalidZONEL2_flg = false;
}

FUNC(void, COM_APPL_CODE) CAN4_SG_ZONE_L2_ComTimeoutNotification(void)
{
    fvt_rtsg_timeout_handler(RTSG_CAN4_SG_ZONE_L2);
	VHAL_CANMsgInvalidZONEL2_flg = true;
}

FUNC(void, COM_APPL_CODE) CAN4_SG_ZONE_R1_ComNotification(void)
{
    fvt_rtsg_notification_handler(RTSG_CAN4_SG_ZONE_R1);
	VHAL_CANMsgInvalidZONER1_flg = false;
}

FUNC(void, COM_APPL_CODE) CAN4_SG_ZONE_R1_ComTimeoutNotification(void)
{
    fvt_rtsg_timeout_handler(RTSG_CAN4_SG_ZONE_R1);
	VHAL_CANMsgInvalidZONER1_flg = true;
}

FUNC(void, COM_APPL_CODE) CAN4_SG_ZONE_R2_ComNotification(void)
{
    fvt_rtsg_notification_handler(RTSG_CAN4_SG_ZONE_R2);
	VHAL_CANMsgInvalidZONER2_flg = false;
}

FUNC(void, COM_APPL_CODE) CAN4_SG_ZONE_R2_ComTimeoutNotification(void)
{
    fvt_rtsg_timeout_handler(RTSG_CAN4_SG_ZONE_R2);
	VHAL_CANMsgInvalidZONER2_flg = true;
}
