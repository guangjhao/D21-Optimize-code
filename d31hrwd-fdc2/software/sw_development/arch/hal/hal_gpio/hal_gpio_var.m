...
disp('Loading $Id: hal_gpio_var.m  2025-04-18 15:05:25    foxtron $      FVT_export_businfo_v2.0 2021-11-02')
...
a2l_mon('VHAL_HoodSW_flg', 	'flg',    0,    1,    'boolean',    '');
a2l_mon('VHAL_TailgateSW_flg', 	'flg',    0,    1,    'boolean',    '');
a2l_mon('VHAL_DrDoorSW_flg', 	'flg',    0,    1,    'boolean',    '');
a2l_mon('VHAL_PsDoorSW_flg', 	'flg',    0,    1,    'boolean',    '');
a2l_mon('VHAL_RRDoorSW_flg', 	'flg',    0,    1,    'boolean',    '');
a2l_mon('VHAL_RLDoorSW_flg', 	'flg',    0,    1,    'boolean',    '');
a2l_mon('VHAL_CentralDoorLockSW_flg', 	'flg',    0,    1,    'boolean',    '');
